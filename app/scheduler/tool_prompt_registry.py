...
_TOOL_PROMPT_ENTRIES: Tuple[SchedulerToolPromptInfo, ...] = (
    ...
    SchedulerToolPromptInfo(
        tool_id="sslyze",
        purpose="Deep TLS protocol, certificate, and cipher validation.",
    ...
    SchedulerToolPromptInfo(
        tool_id="testssl.sh",
        purpose="Alternative TLS posture and certificate validation.",
        when_to_use="Use when TLS is present and sslyze is unavailable or unstable locally.",
        arg_shape="host:port",
        phase_tags=("service_fingerprint", "protocol_checks", "targeted_checks"),
        prompt_groups=("web_specialist_followup",),
        safe_parallel=False,
    ...
    SchedulerToolPromptInfo(
        tool_id="http-wapiti",
        purpose="HTTP application follow-up scanning.",
        when_to_use="Use for deeper application validation when a web target justifies a broader follow-up.",
        arg_shape="web_url",
        phase_tags=("targeted_checks", "deep_web"),
        prompt_groups=("web_specialist_followup",),
        safe_parallel=False,
    ...
    SchedulerToolPromptInfo(
        tool_id="https-wapiti",
        purpose="HTTPS application follow-up scanning.",
        when_to_use="Use for deeper application validation when a TLS web target justifies a broader follow-up.",
        arg_shape="web_url",
        phase_tags=("targeted_checks", "deep_web"),
        prompt_groups=("web_specialist_followup",),
        safe_parallel=False,
    ...
    SchedulerToolPromptInfo(
        tool_id="netexec",
        purpose="Modern SMB and LDAP-aware internal validation.",
        when_to_use="Use when deeper credential-aware internal enumeration is justified and the tool is locally available.",
        arg_shape="host",
        phase_tags=("protocol_checks", "targeted_checks"),
        prompt_groups=("internal_safe_enum",),
        safe_parallel=False,
