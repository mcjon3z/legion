...
DEFAULT_STRATEGY_PACKS: Tuple[StrategyPack, ...] = (
    ...
    StrategyPack(
        ...
        preferred_tool_tokens=["http", "https", "web", "api", "graphql", "swagger", "wordpress", "wp", "nikto", "whatweb", "gobuster", "feroxbuster", "dirsearch", "ffuf", "wpscan"],
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["banner", "screenshooter", "smb-security-mode", "smb2-security-mode", "smb-enum-users.nse", "enum4linux-ng", "smbmap", "rpcclient-enum"],
        preferred_tool_tokens=["smb", "ldap", "kerberos", "rpc", "winrm", "rdp", "snmp", "enum", "banner", "screenshot", "enum4linux", "smbmap", "rpcclient"],
        ...
        coverage_gap_tools={
            ...
            "missing_internal_safe_enum": ["enum4linux-ng", "smbmap", "rpcclient-enum"],
        },
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["smb-security-mode", "smb2-security-mode", "smb-enum-users.nse", "enum4linux-ng", "smbmap", "rpcclient-enum"],
        preferred_tool_tokens=["smb", "ldap", "kerberos", "ntlm", "relay", "auth", "credential", "signing", "responder", "enum4linux", "smbmap", "rpcclient"],
