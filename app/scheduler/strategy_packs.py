...
DEFAULT_STRATEGY_PACKS: Tuple[StrategyPack, ...] = (
    StrategyPack(
        ...
        preferred_tool_tokens=["http", "https", "web", "ssl", "tls", "headers", "title", "content", "favicon"],
        ...
        coverage_gap_tools={
            ...
            "missing_nikto": ["nikto"],
            "missing_web_content_discovery": ["web-content-discovery"],
        },
    ...
    StrategyPack(
        ...
        preferred_tool_tokens=["http", "https", "web", "api", "graphql", "swagger", "wordpress", "wp", "nikto", "whatweb", "gobuster", "feroxbuster", "wpscan"],
        blocked_tool_tokens=["smb", "ldap", "kerberos", "msrpc", "winrm"],
        coverage_gap_tools={
            "missing_screenshot": ["screenshooter"],
            "missing_nmap_vuln": ["nmap-vuln.nse"],
            "missing_nuclei_auto": ["nuclei-web"],
            "missing_technology_fingerprint": ["whatweb", "whatweb-http", "whatweb-https"],
            "missing_whatweb": ["whatweb", "whatweb-http", "whatweb-https"],
            "missing_nikto": ["nikto"],
            "missing_web_content_discovery": ["web-content-discovery"],
            "missing_followup_after_vuln": ["whatweb", "nikto", "web-content-discovery"],
        },
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["banner", "screenshooter", "smb-security-mode", "smb2-security-mode", "smb-enum-users.nse"],
        preferred_tool_tokens=["smb", "ldap", "kerberos", "rpc", "winrm", "rdp", "snmp", "enum", "banner", "screenshot"],
        blocked_tool_tokens=["nikto", "whatweb", "wpscan", "web-content-discovery"],
        coverage_gap_tools={
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["smb-security-mode", "smb2-security-mode", "smb-enum-users.nse"],
        preferred_tool_tokens=["smb", "ldap", "kerberos", "ntlm", "relay", "auth", "credential", "signing", "responder"],
        blocked_tool_tokens=["nikto", "whatweb", "wpscan"],
        coverage_gap_tools={
            "missing_smb_signing_checks": ["smb-security-mode", "smb2-security-mode"],
            "missing_smb_followup_after_vuln": ["smb-security-mode", "smb2-security-mode"],
        },
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["nmap-vuln.nse", "nuclei-web", "whatweb", "nikto", "web-content-discovery"],
    ...
    StrategyPack(
        ...
        preferred_tool_ids=["sslscan", "sslyze", "wafw00f", "nmap-vuln.nse", "nuclei-web", "screenshooter"],
        ...
        coverage_gap_tools={
            ...
            "missing_nuclei_auto": ["nuclei-web"],
            "missing_cpe_cve_enrichment": ["nmap-vuln.nse", "nuclei-web"],
            "missing_deep_tls_waf_checks": ["sslscan", "sslyze", "wafw00f"],
        },
