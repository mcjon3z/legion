...
DEFAULT_STRATEGY_PACKS: Tuple[StrategyPack, ...] = (
    StrategyPack(
        ...
        coverage_gap_tools={
            ...
            "missing_nikto": ["nikto"],
            "missing_web_content_discovery": ["web-content-discovery", "katana", "dirsearch", "ffuf"],
    ...
    StrategyPack(
        ...
        preferred_tool_tokens=["http", "https", "web", "api", "graphql", "swagger", "wordpress", "wp", "nikto", "whatweb", "httpx", "gobuster", "feroxbuster", "dirsearch", "ffuf", "katana", "wpscan"],
